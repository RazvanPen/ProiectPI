...
public class NewAccReg extends JFrame implements ActionListener, MouseListener{
	...
	private ImageIcon Logo = new ImageIcon(new ImageIcon("poza6.png").getImage().getScaledInstance(400, 150, Image.SCALE_SMOOTH));
	...
	public void actionPerformed(ActionEvent e) {
		/** Aici se realizeaza din nou conectiunea cu baza de date si verificam daca datele pentru creearea unui cont nou respecta criteriile.
		 * Daca se respecta se va realiza logarea cu succes.
		*/
			...
			if(!password1.getText().equals(password2.getText())) {
				...
				try {
					...
					if(res.next()) {
						...
						stmt.execute("insert into users values(default, '" + prenume.getText() + "', '" + nume.getText() + "', '" + email.getText() + "', '" + nrtelefon.getText() +  "','" + nickname.getText() + "', '" +  password1.getText() +"') ");
	...
	public NewAccReg() {
		...
		welcomemess.setIcon(Logo);
		welcomemess.setBounds(430, 0, 400, 150);
